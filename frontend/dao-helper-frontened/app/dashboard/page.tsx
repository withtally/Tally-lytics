...
export default function DashboardPage() {
  ...
  const recentCrawls = [
    { id: 1, source: 'Aave Forum', status: 'Completed', documents: 124, timestamp: '2025-03-13 12:34:21' },
    { id: 2, source: 'Uniswap Forum', status: 'In Progress', documents: 45, timestamp: '2025-03-13 16:12:09' },
    { id: 3, source: 'Compound Forum', status: 'Scheduled', documents: 0, timestamp: '2025-03-14 01:00:00' },
  ];
      ...
      <div className="container mx-auto py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-sm font-medium text-muted-foreground">{statistics.lastUpdate}</div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Button className="w-full" variant="outline">View All Sources</Button>
